                ...
                <div class="row g-3">
                  ...
                  @if($is_bonus)
                    <div class="col-md-6">
                      ...
                      <input type="number" wire:model.live="bonuses_claimed" class="form-control @error('bonuses_claimed') is-invalid @enderror" min="1">
                  ...
                  <tbody>
                    @forelse($items as $index => $item)
                      <tr>
                        ...
                        <td>
                          <input type="number" wire:model.live="items.{{ $index }}.quantity" class="form-control form-control-sm text-center font-weight-semibold" min="1">
                        </td>
              ...
              <div class="card-body">
                ...
                <div class="mb-4">
                  ...
                  <div class="input-group">
                    ...
                    <input type="number" wire:model.live="ongkir" class="form-control text-end font-weight-bold" min="0" placeholder="0">
                  </div>
                </div>
